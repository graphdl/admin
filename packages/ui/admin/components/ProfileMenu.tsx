...
export default function ProfileMenu() {
  return (
    <Menu as="div" className="relative ml-4">
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-[14px] w-48 origin-top-right rounded-b-md bg-[#161b22] pb-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none border border-gray-700 border-t-0 rounded-tr-0">
